...
class FilterableFieldValidatorTest {
    ...
    void validate_acceptsDefaultOperator() throws Exception {
        ...
        assertDoesNotThrow(() -> validator.validate(new FilterableFieldValidator.Field(field, RSQLDefaultOperator.EQUAL.getOperator(), "name")));
    }
    ...
    void validate_acceptsCustomOperatorWhenRegistered() throws Exception {
        ...
        assertDoesNotThrow(() -> validator.validate(new FilterableFieldValidator.Field(field, new ComparisonOperator("=mock="), "name")));
    }
    ...
    void validate_rejectsUnregisteredCustomOperator() throws Exception {
        FilterableFieldValidator validator = new FilterableFieldValidator(Map.of());
        var field = FilterableEntity.class.getDeclaredField("name");
        assertThrows(QueryConfigurationException.class, () -> validator.validate(new FilterableFieldValidator.Field(field, new ComparisonOperator("=mock="), "name")));
    }
    ...
    void validate_rejectsDisallowedOperator() throws Exception {
        FilterableFieldValidator validator = new FilterableFieldValidator(Map.of());
        var field = DefaultOnlyFilterableEntity.class.getDeclaredField("name");
        assertThrows(QueryForbiddenOperatorException.class, () -> validator.validate(new FilterableFieldValidator.Field(field, RSQLDefaultOperator.NOT_EQUAL.getOperator(), "name")));
    }
    ...
    void validate_rejectsNonFilterableField() throws Exception {
        ...
        assertThrows(QueryFieldValidationException.class, () -> validator.validate(new FilterableFieldValidator.Field(field, RSQLDefaultOperator.EQUAL.getOperator(), "name")));
    }
