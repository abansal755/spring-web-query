...
public class EntityRsqlSpecArgumentResolver implements HandlerMethodArgumentResolver {

    private final RSQLParser rsqlParser;
    private final List<RSQLCustomPredicate<?>> customPredicates;
    private final AnnotationUtil annotationUtil;

    public EntityRsqlSpecArgumentResolver(Set<RsqlOperator> defaultOperators, Set<? extends RsqlCustomOperator<?>> customOperators, AnnotationUtil annotationUtil) {
