 ...
 *         {@link io.github.abansal755.springwebquery.annotation.RsqlFilterable}</li>
 *     <li>A query uses an operator not allowed for a specific field</li>
 *     <li>A sort request targets a field not annotated with
 *         {@link io.github.abansal755.springwebquery.annotation.Sortable}</li>
 ...
 * to API clients.</p>
 *
 * @see io.github.abansal755.springwebquery.annotation.RsqlFilterable
 * @see io.github.abansal755.springwebquery.annotation.Sortable
 */
