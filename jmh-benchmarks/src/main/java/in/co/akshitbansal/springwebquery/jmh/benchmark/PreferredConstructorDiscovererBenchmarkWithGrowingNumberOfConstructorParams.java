...
public class PreferredConstructorDiscovererBenchmarkWithGrowingNumberOfConstructorParams {
	...
	public static class TestParams {
		...
		public void setup() throws NoSuchMethodException {
			...
			DynamicType.Builder<?> builder = new ByteBuddy()
					...
					.name("in.co.akshitbansal.springwebquery.jmh.benchmark.GrowingNumberOfConstructorParamsTestClass" + size)
	...
	@Benchmark
	public Constructor<?> testDiscoverWithGrowingNumberOfConstructorParams(TestParams params) {
